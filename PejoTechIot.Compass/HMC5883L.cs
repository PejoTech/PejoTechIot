...
namespace PejoTechIot.Compass
{
    public class Hmc5883L : AbstractI2CDevice
    {
        ...
        private byte[] _firstDataRegister = new byte[] { 0x03 };

        private byte[] _identificationRegisterA = new byte[] { 0x0A };

        private byte[] _identificationRegisterB = new byte[] { 0x0B };

        private byte[] _identificationRegisterC = new byte[] { 0x0C };
        ...
        private double VectorLength(short x, short y, short z)
        {
